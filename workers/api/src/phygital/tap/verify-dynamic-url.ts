...
import { base64UrlToBytes } from "@/shared/base64";
 ...
 *
 * Counter anti-replay is enforced by `/api/verify-tap`: KV reentry grace plus
 * D1 strict monotonic advance (`tryAdvanceD1Counter`).
 */
