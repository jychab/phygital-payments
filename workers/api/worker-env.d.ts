/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv worker-env.d.ts` (hash: 72451dbcc1d8b09e6929a90911f80211)
...
interface __BaseEnv_CloudflareEnv {
	...
	APP_ORIGIN: string;
	SIGNER: Fetcher /* phygital-payments-signer */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SOLANA_RPC_URL" | "NEXT_PUBLIC_SOLANA_CLUSTER" | "WALLET_SESSION_SECRET" | "SIGNER_INTERNAL_TOKEN" | "SIGNER_ORIGIN" | "APP_ORIGIN">> {}
}
