/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 823ec6d8311e0f92435feaef5c65fa64)
...
interface __BaseEnv_CloudflareEnv {
	...
	NEXT_PUBLIC_API_ORIGIN: "https://api.revibase.com";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.open-next/worker.js");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SOLANA_RPC_URL" | "NEXT_PUBLIC_SOLANA_CLUSTER" | "NEXT_PUBLIC_API_ORIGIN">> {}
}
