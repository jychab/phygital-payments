/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: cd0a5aad8ad29c117cd8e637df51bdf2)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "NEXT_PUBLIC_SOLANA_CLUSTER" | "NEXT_PUBLIC_SOLANA_RPC_URL" | "NEXT_PUBLIC_FEE_PAYER_PUBLIC_KEY" | "FEE_PAYER_SECRET_KEY" | "HELIUS_WEBHOOK_AUTH" | "PAY_HMAC_SECRET" | "JUPITER_API_KEY">> {}
}
