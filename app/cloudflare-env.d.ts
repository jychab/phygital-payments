/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: c06cede297b6eed834159c040daaeddb)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "TransferSubmitterDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "FEE_PAYER_SECRET_KEY" | "PRIVY_VERIFICATION_KEY" | "HELIUS_WEBHOOK_AUTH" | "NEXT_PUBLIC_PRIVY_APP_ID" | "NEXT_PUBLIC_SOLANA_RPC_URL" | "NEXT_PUBLIC_SOLANA_CLUSTER" | "NEXT_PUBLIC_FEE_PAYER_PUBLIC_KEY">> {}
}
