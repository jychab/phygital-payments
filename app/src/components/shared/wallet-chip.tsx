...
import { ChevronDown, Copy, KeyRound, LogOut } from "lucide-react";
...
/** Official multicolor Google “G” — embedded wallets come from Google login. */
...
export function WalletChip({ className }: { className?: string }) {
  ...
  async function onShowPrivateKey() {
    if (!address) return;
    try {
